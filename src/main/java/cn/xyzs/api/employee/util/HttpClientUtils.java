package cn.xyzs.api.employee.util;
...
public class HttpClientUtils{
    ...
    public static void main(String[] args){
        ...
        String APPID ="11640984"; //管理中心获得

        //百度人脸识别应用apikey
        String API_KEY = "glbjbEUFnu2Oreaf8GD43GsG"; //管理中心获得

        //百度人脸识别应用sercetkey
        String SERCET_KEY = "ozCvw3h4SGKcS3IogArQG0A06mhdG9Kh"; //管理中心获得
